...
export const defaultDesign:SiteDesign={primaryColor:"#b348d0",accentColor:"#63267d",backgroundColor:"#fff7ff",headingColor:"#572067",textColor:"#51405f",fontSize:16,buttonRadius:18,cardRadius:25,sections:{hero:{visible:true,order:1},packages:{visible:true,order:2},benefits:{visible:true,order:3},teacher:{visible:true,order:4},featured:{visible:true,order:5},cta:{visible:true,order:6},faq:{visible:true,order:7},footer:{visible:true,order:8}}};
