...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$testimonials$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/testimonials.ts [app-route] (ecmascript)");
;
;
;
const runtime = "nodejs";
async function GET() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$testimonials$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readTestimonials"])());
}
async function PUT(r) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$testimonials$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeTestimonials"])(items);
...
"[project]/lib/testimonials.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(process.cwd(), "data", "testimonials.json");
const defaults = [
    {
        id: "1",
        name: "مادر آریا",
        relation: "پکیج استارتر",
        text: "کودکم با علاقه بازی می‌کند و اولین کلمات انگلیسی را با شادی تکرار می‌کند.",
        rating: 5
    },
    {
        id: "2",
        name: "مادر باران",
        relation: "پکیج مقدماتی",
        text: "راهنمای مرحله‌به‌مرحله برای ما خیلی کاربردی بود و می‌دانستیم هر روز چه کار کنیم.",
        rating: 5
    },
    {
        id: "3",
        name: "مادر یسنا",
        relation: "پکیج پایه",
        text: "کیفیت کارت‌ها و فعالیت‌ها عالی است؛ یادگیری برای فرزندم تبدیل به بازی شده است.",
        rating: 5
    }
];
async function readTestimonials() {
    try {
        return JSON.parse(await __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["promises"].readFile(filePath, "utf8"));
    } catch  {
        await writeTestimonials(defaults);
        return defaults;
    }
}
async function writeTestimonials(items) {
    ...
    await __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["promises"].writeFile(filePath, JSON.stringify(items, null, 2), "utf8");
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__0lv62pv._.js.map